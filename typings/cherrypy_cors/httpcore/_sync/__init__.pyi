...
class Socks5Connection(ConnectionInterface):
    def __init__(self, proxy_origin: Origin, remote_origin: Origin, proxy_auth: typing.Optional[typing.Tuple[bytes, bytes]] = ..., ssl_context: typing.Optional[ssl.SSLContext] = ..., keepalive_expiry: typing.Optional[float] = ..., http1: bool = ..., http2: bool = ..., network_backend: typing.Optional[NetworkBackend] = ...) -> None:
        ...
