...
class SpiderFootDb:
    ...
    def eventTypes(self) -> typing.Sequence[typing.Tuple[str, str, int, str]]:
        ...
        try:
            with self._sync_session_factory.begin() as ctx:
                tbl_event_types_raw_iter = ctx.scalars(sqlalchemy.text(qry))
        except sqlalchemy.exc.DBAPIError as e:
            raise IOError("SQL error encountered when retrieving event types") from e
        tbl_event_types_iter = tbl_event_types_raw_iter.all()
        return tbl_event_types_iter
    ...
    def scanLogEvents(self, batch: typing.List[typing.Tuple[str, str, str, typing.Optional[str], float]]) -> bool:
        ...
        inserts: typing.List[typing.Tuple[str, float, str, str, str]] = []
